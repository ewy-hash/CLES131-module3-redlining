...
Baltimore_vect <- as_spatvector(Baltimore)
NDVI_inside <- mask(NDVIbaltimorePLOT,Baltimore_vect)
NDVI_outside <- mask(NDVIbaltimorePLOT,Baltimore_vect, inverse=TRUE)
