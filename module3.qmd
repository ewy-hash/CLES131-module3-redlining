...
```{r}
vector <- vect(Baltimore)
 
extracted <- extract(x = NDVIbaltimore, y = vector, method = "simple" )
#need to mask?
mean(extracted$T18SUJ_20230525T154941_B08)
median(extracted$T18SUJ_20230525T154941_B08)
