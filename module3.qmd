...
combined <- ggplot(data = combined, mapping = aes(x = grade, y = NDVI_mean$T12SUC_20211110T180601_B08))+
...
#birmingham
1<- ggplot(data = Birmingham, mapping = aes(x = grade, y = Birmingham$NDVI_mean$T16SEC_20220427T162829_B08))+
  geom_smooth(aes(group = 1))+
  scale_y_continuous(name = "NDVI")+
  labs(title = "NDVI compared to grade in Birmingham")

#phoenix
2<-ggplot(data = Phoenix, mapping = aes(x = grade, y = Phoenix$NDVI_mean$T12SUC_20211110T180601_B08))+
  geom_smooth(aes(group = 1))+
  scale_y_continuous(name = "NDVI")+
  labs(title = "NDVI compared to grade in Phoenix")

#indianapolis
3<-ggplot(data = Indianapolis, mapping = aes(x = grade, y = Indianapolis$NDVI_mean$T16TEK_20210726T162901_B08))+
  geom_smooth(aes(group = 1))+
  scale_y_continuous(name = "NDVI")+
  labs(title = "NDVI compared to grade in Indianapolis")

#minneapolis
4<-ggplot(data = Minneapolis, mapping = aes(x = grade, y = Minneapolis$NDVI_mean$T15TVK_20220603T170901_B08))+
  geom_smooth(aes(group = 1))+
  scale_y_continuous(name = "NDVI")+
  labs(title = "NDVI compared to grade in Minneapolis")

#baltimore
5<-ggplot(data = Baltimore, mapping = aes(x = grade, y = Baltimore$NDVI_mean$T18SUJ_20230525T154941_B08))+
  geom_smooth(aes(group = 1))+
  scale_y_continuous(name = "NDVI")+
  labs(title = "NDVI compared to grade in Baltimore")

facet_wrap(facets = combined,1,2,3,4,5)
